...
export function UpdateForm() {
  ...
  const employeeId = Number(idParams);
  const filterEmployee = store.employees.filter((employee) => {
    return employee.id === employeeId;
  });
  const selectedEmployee = filterEmployee[0];

  useEffect(() => {
    fetch(selectedEmployee?.avatar)
      .then((res) => res.blob())
      .then((blob) => {
  ...
  return (
    <>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="flex flex-wrap gap-2" {...field}>
                              <SingleImageDropzone
                                width={200}
                                height={200}
                                value={file}
      ...
      {!idParams && (
        <Card>
          <CardHeader>
            <CardTitle>Please Select an Employee to Edit</CardTitle>
